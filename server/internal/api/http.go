...
func (h *HTTPHandler) Routes() http.Handler {
	...
	r.Put("/api/agent-config/backups", h.protectedEndpoint(h.handleAgentConfigBackupUpdate))
	r.Delete("/api/agent-config/backups", h.protectedEndpoint(h.handleAgentConfigBackupDelete))
	r.Get("/api/agent-config/backups/file", h.protectedEndpoint(h.handleAgentConfigBackupFileGet))
	r.Put("/api/agent-config/backups/file", h.protectedEndpoint(h.handleAgentConfigBackupFilePut))
	r.Get("/api/agent-config/backups/env", h.protectedEndpoint(h.handleAgentConfigBackupEnvGet))
	r.Post("/api/agent-config/preview-file", h.protectedEndpoint(h.handleAgentConfigPreviewFile))
